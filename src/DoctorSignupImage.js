...
export default function DoctorSignupImage()
{
      ...
      newdate.setFullYear(passingyear);
            ...
            .then(Response=>{
                if(Response.status===200)
                {
                    ...
                    axios.post("http://localhost:8080/uploadimg/"+docid,formData,config)
                    .then(Response=>{
                        if(Response.status===200)
                        {
        ...
        <div className="signup-form">
          <form method="POST" className="register-form" id="register-form">
            ...
            <div className="form-group">
              ...
              <input type="file" style={{paddingInline:10}} id="image" accept="image/*" required onChange={(event)=>{setImage(event.target.files[0])}} />
            </div>
            </div>
