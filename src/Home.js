  ...
  <section id="hero" className="d-flex align-items-center">
    ...
    <section id="contact" className="contact">
      ...
      <div className="row">
        <div className="col-lg-4 d-flex align-items-stretch">
          <div className="container">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3782.9923132172066!2d73.8335912!3d18.529249499999995!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc2bf4a06f8ec33%3A0x8fbd07f290a4163a!2sIET%20C-DAC%20ACTS%20ATC%2C%20Pune!5e0!3m2!1sen!2sin!4v1664078478930!5m2!1sen!2sin" width="600" height="450" style={{"border":"0;"}} allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
          </div>
        </div>
        <div className="col-lg-8 d-flex align-items-stretch">
          <div className="container">
              ...
              <div className="col-lg-4">
                <div className="info">
                  <div className="address">
                    ...
                    <h4>Location:</h4>
                    <p>Office No. 401, A-wing, Swastik Society Manikchand Galleria, Model Colony, Shivajinagar, Pune, Maharashtra 411016</p>
                  </div>
      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-lg-3 col-md-6 footer-contact">
            <h3>WeCare Pvt.Ltd</h3>
            <p>
            Office No. 401, A-wing, Swastik Society Manikchand Galleria, Model Colony, Shivajinagar, Pune, Maharashtra 411016 <br/><br/>
    ...
    <div className="container d-md-flex py-4">
      ...
      <div className="me-md-auto text-center text-md-start">
        ...
        <div className="credits">
          ...
          Designed by <a href="#contact">Group No. 4</a>
        </div>
      </div>
