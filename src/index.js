...
import DoctorSignupImage from './DoctorSignupImage';
import DoctorNewProfile from './DoctorNewProfile';
...
root.render(
  <React.StrictMode>
    ...
    <Routes>
      ...
      <Route path='/newdoctor' element={<DoctorSignupImage/>}></Route>
      <Route path='/doctor' element={<DoctorNewProfile/>}></Route>
    </Routes>
    </Provider>
</BrowserRouter>
  </React.StrictMode>
